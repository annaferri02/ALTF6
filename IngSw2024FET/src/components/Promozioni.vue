...
<template>
  <head>
    <title>Promuovi il tuo evento</title>
  </head>
  <body>
    <header>
      <div class="logo">
    ...
    <main>
      <div class="promotion_section">
        ...
        <button class="center-button" @click="Pagamento.vue">AUMENTA LA VISIBILITÀ DEL TUO EVENTO</button>
